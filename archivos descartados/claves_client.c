...
claves_1(char *host)
{
	...
	int result_3;
	struct args rpc_get_value_1_arg;
	enum clnt_stat retval_4;
	int result_4;
	struct args rpc_modify_value_1_arg;
	enum clnt_stat retval_5;
	int result_5;
	struct args rpc_delete_key_1_arg;
	enum clnt_stat retval_6;
	int result_6;
	struct args rpc_exist_1_arg;
	...
	retval_3 = rpc_get_value_1(rpc_get_value_1_arg, &result_3, clnt);
	...
	retval_5 = rpc_delete_key_1(rpc_delete_key_1_arg, &result_5, clnt);
	if (retval_5 != RPC_SUCCESS) {
		clnt_perror (clnt, "call failed");
	}
	retval_6 = rpc_exist_1(rpc_exist_1_arg, &result_6, clnt);
